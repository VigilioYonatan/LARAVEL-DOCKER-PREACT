...
function Provider(el: Element, children: JSX.Element | JSX.Element[]) {
    return renderPreact(<Suspense fallback={null}>{children}</Suspense>, el);
}
